...
if (message.content === '<@718711851596120094>') {
  const embed = new Discord.RichEmbed()
  .setTitle('Ben Türk:')
  .setDescription('Prefixim: `n!`')
  .setFooter('Türk')
  .setColor('RANDOM')
 message.reply(embed)
}
...
client.on("message", message => {
    ...
    if (message.content === prefix + "bilgi") {
        const embed = new Discord.RichEmbed()
            ...
            .addField("Bot Sahibi", `<@718711851596120094>`, true)
...
client.on('guildCreate', async guild => {
  const girismesaj = [
    ...
    'Bu bot **<@718711851596120094>** tarafından geliştirilmektedir.',
...
client.on("message", msg => {
	const uyarıembed = new Discord.RichEmbed()
      .setColor(0x00AE86)
      .setDescription("<a:attention:718711851596120094>" + msg.author + " Nyhtm Bot reklam koruması aktif, reklam yapmayı bırak evlat! <a:attention:718711851596120094>")

const dmembed = new Discord.RichEmbed()
	.setTitle("Sunucunda " + msg.author.tag + " reklam yapıyor!")
      .setColor(0x00AE86)
      .setDescription("n!uyar <kişi> komutu ile onu uyarabilir ya da t!kick <kişi> veya t!ban <kişi> komutlarını kullanarak onu sunucudan uzaklaştırabilirsin!")
...
client.on('message', async msg => {
	...
	if (command === 'çal') {
      ...
      .setColor('RANDOM')
    .setDescription('<a:warning:505984020790902785> | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
		const permissions = voiceChannel.permissionsFor(msg.client.user);
		if (!permissions.has('CONNECT')) {
			return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
    .setTitle('<a:warning:505984020790902785> | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
		}
		if (!permissions.has('SPEAK')) {
			 return msg.channel.sendEmbed(new Discord.RichEmbed()
      .setColor('RANDOM')
      .setTitle('<a:warning::505984020790902785> | Şarkı başlatılamıyor. Lütfen mikrofonumu açınız.'));
        }
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('Nyhtm Bot | Şarkı Seçimi')
          ...
          msg.delete(5000)
					try {
						...
						console.error(err);
						 return msg.channel.sendEmbed(new Discord.RichEmbed()
            .setColor('0x36393E')
            .setDescription('<a:warning:505984020790902785>| **Şarkı Değeri Belirtmediğiniz İçin Seçim İptal Edilmiştir**.'));
                    }
					...
					return msg.channel.sendEmbed(new Discord.RichEmbed()
          .setColor('0x36393E')
          .setDescription('<a:warning:505984020790902785> | **Aradaım Fakat Hiç Bir Sonuç Çıkmadı**'));
                }
            }
    ...
    .setColor('RANDOM')
    .setDescription('<a:warning:505984020790902785> | **Lütfen öncelikle sesli bir kanala katılınız**.'));
		if (!serverQueue) return msg.channel.sendEmbed(new Discord.RichEmbed()
     .setColor('RANDOM')
     .setTitle('<a:warning:505984020790902785> | **Hiç Bir Müzik Çalmamakta**'));                                              
   ...
   .setTitle(`:loud_sound: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));                             
		...
		if (!serverQueue) return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setTitle("<a:warning:505984020790902785> | **Çalan Müzik Bulunmamakta**")
    .setColor('RANDOM'));
		return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
    .setTitle("Nyhtm Bot | Çalan")                            
    .addField('Başlık', `[${serverQueue.songs[0].title}](${serverQueue.songs[0].url})`, true)
    .addField("Süre", `${serverQueue.songs[0].durationm}:${serverQueue.songs[0].durations}`, true))
	} else if (command === 'sıra') {
    let index = 0;
		if (!serverQueue) return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setTitle("<a:warning:505984020790902785> | **Sırada Müzik Bulunmamakta**")
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('Nyhtm Bot | Şarkı Kuyruğu')
    ...
    .addField('Şu anda çalınan: ' + `${serverQueue.songs[0].title}`);
      ...
      .setColor('RANDOM'));
		...
		return msg.channel.send('<a:warning:505984020790902785> | **Çalan Müzik Bulunmamakta**');
...
function play(guild, song) {
	...
	const dispatcher = serverQueue.connection.playStream(ytdl(song.url))
		.on('end', reason => {
			if (reason === '<a:warning:505984020790902785> | **Yayın Akış Hızı Yeterli Değil.**') console.log('Müzik Bitti.');
  ...
  .setTitle("**Nyhtm Bot| 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
...
.then(channel =>
            ...
            message.guild.createChannel('Yapımcım: ! HΛЯÐ ℂ⋆ Sálvádøre#0001', 'voice', [{
              id: message.guild.id,
              deny: ['CONNECT']
            }])
            .then(channel =>
...
client.on('guildMemberAdd', member => {
  const embed = new Discord.RichEmbed()
    ...
    .addField('Bu Sunucu Nyhtm Botunu Kullanıyor!')
...
client.on("guildMemberAdd", (member) => {
try {
member.guild.setName(`Machine6 test 〔${member.guild.memberCount}〕`); 
}
catch (e) {
console.log(e);
}
...
client.on('guildMemberAdd ', member =>{
member.guild.channels.get('626082209731706898').send(`
Hoş geldin! ${member} seninle {member.guild.memberCount} kişiyiz!
`)
});

client.on("guildMemberAdd", member => {
if(member.guild.id !== "573548174267121706") return; //tırnak işareti arasına sunucu id
let eskiNick = member.user.username;
const id = "626082209237041152" //Kanal id
...
client.on('guildMemberAdd', member => {
  ...
  if(profil[member.guild.id]) {
    ...
    sayaçkanal.sendMessage("**:wave: " + member + " sunucumuza katıldı. `" + sayaçsayı + "` kişi olmamıza `" + aralık + "` kişi kaldı! `" +  member.guild.members.size + "` kişiyiz!**")
  }
});

client.on ("message", async msg => {
  
  if (msg.channel.type === "dm") döndürürse;
  if (msg.author.bot) döndürür;  
  
  if (msg.content.length> 7) {
    
    db.add (`puan _ $ {msg.author.id + msg.guild.id}`, 3)
};

  if (db.fetch (`puan _ $ {msg.author.id + msg.guild.id}`)> 150) {
    
    db.add (`seviye _ $ {msg.author.id + msg.guild.id}`, 1)
    
    db.delete (`puan _ $ {msg.author.id + msg.guild.id}`)
...
  client.channels.get("636280926153736192").setName(`🔴 Kişi Sayısı: ${message.guild.memberCount} 📤`);
});
...
client.on('guildCreate', async guild => {
  const girismesaj = [
    'Botum sunucunuza eklendi.',
    'Bu bot **!  Nehona_965#5300** tarafından geliştirilmektedir.',
    'Botumuz El ile kodlanmıştır.',
    'Nyhtm ismi eski bir anımızdan gelmiştir.',
    '100 den fazla komut Bulunmaktadır.',
    'Botu eklediğin için teşekkürler!',
  ]
  guild.owner.send(girismesaj)
  console.log(`LOG: ${guild.name}. sunucuya katıldım!`);
})
...
client.on("message", msg => {
var dm = client.channels.get("638034453385707520")
...
let channel = client.channels.get('639342313893789696');
